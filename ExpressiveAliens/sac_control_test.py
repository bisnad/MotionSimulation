"""
this goes along with sac_constant_train_v4_controls_debug_v2.py
"""
...
result_file_path = "training_pytorch/biped_target1.0_ground20.0_run10_controls_debug_v2"
...
def randomise_rewards():
    ...
    # effort selection
    effort_type = random.randint(0, 4)
