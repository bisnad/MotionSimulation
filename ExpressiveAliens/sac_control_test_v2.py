...
def randomise_rewards():
    ...
    # 2. Sample continuous effort weights
    weight_w = random.uniform(0.0, 1.0)
    time_w = random.uniform(0.0, 1.0)
    space_w = random.uniform(0.0, 1.0)
    flow_w = random.uniform(0.0, 1.0)
    
    # Optional but recommended: Normalize weights so their sum is 1.0
    # This prevents the total effort reward from growing arbitrarily large
    ...
    # 3. Sample continuous target values for the efforts (e.g., between 0.0 and 1.0)
    weight_t = random.uniform(0.0, 1.0)
    time_t = random.uniform(0.0, 1.0)
    space_t = random.uniform(0.0, 1.0)
    flow_t = random.uniform(0.0, 1.0)
